...
export interface ApiStaticResourceStaticResource
  extends Struct.CollectionTypeSchema {
  collectionName: 'static_resources';
  info: {
    displayName: 'Static Resources';
    pluralName: 'static-resources';
    singularName: 'static-resource';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::static-resource.static-resource'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::static-resource.static-resource': ApiStaticResourceStaticResource;
