...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A regional chapter with its own microsite';
    displayName: 'Chapter';
    pluralName: 'chapters';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    memberPrice: Schema.Attribute.Decimal;
...
export interface ApiFormSubmissionFormSubmission
  ...
  info: {
    description: 'Captured contact form submissions';
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A partner or sponsor organization';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Downloadable files and off-site long-form video, including webinars';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    administeredChapters: Schema.Attribute.Relation<
      'manyToMany',
      'api::chapter.chapter'
    >;
